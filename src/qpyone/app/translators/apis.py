...
from qpyone.app.translators.models import TranslateResponse, Document, \
    TranslatedFileResponse
from qpyone.app.translators.service import get_document_from_file, get_translate_results, \
    save_translate_result
from qpyone.compnents.splitters.text_spliter import text_splitter
...
async def translate_file(
    ...
    try:
        results = await get_translate_results(documents, translate_type=translate_type, api_type=api_type)
        await save_translate_result(results)
