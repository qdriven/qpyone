    ...
    def create_completion(
        ...
        **kwargs
        ...
        Args:
            ...
            messages (Messages): The messages to process. to mixed with prompts
...
class BaseShuffleRetryProvider(BaseProvider):
    """
...
ProviderType = Union[Type[BaseProvider], BaseShuffleRetryProvider]
