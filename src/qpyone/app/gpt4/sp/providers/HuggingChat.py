...
from qpyone.app.gpt4.sp.base.utils import get_random_string, get_connector, get_cookies
    ...
    async def create_async_generator(
        ...
        **kwargs
        ...
        async with ClientSession(
            ...
            async with session.post(f"{cls.url}/conversation", json={"model": cls.get_ai_model(model)}, proxy=proxy) as response:
