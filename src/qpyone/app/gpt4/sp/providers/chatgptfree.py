...
from qpyone.app.gpt4.sp.base.base_async_provider import AsyncProvider
...
from qpyone.app.gpt4.sp.base.utils import get_cookies
...
class ChatgptFree(AsyncProvider):
    ...
    async def create_async(
        ...
        **kwargs
        ...
        if not cookies:
            raise RuntimeError(
                f"g4f.provider.{cls.__name__} requires cookies [refresh https://chatgptfree.ai on chrome]")
        ...
        async with StreamSession(
            ...
            async with session.post(f"{cls.url}/wp-admin/admin-ajax.php", data=data,
