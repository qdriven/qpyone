...
from qpyone.app.gpt4.sp.base.utils import get_random_string, get_connector
...
class OnlineGpt(AsyncGeneratorProvider):
    ...
    async def create_async_generator(
        ...
        **kwargs
        ...
        async with ClientSession(headers=headers,connector=get_connector(proxy)) as session:
            data = {
                "botId": "default",
                "customId": None,
