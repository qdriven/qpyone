...
#         return get_pypi_version(pkg_name)
#     except PackageNotFoundError:
#         # Else use Github version:
#         return get_github_version("fluent-qa/qpyone")
#
#
# class VersionUtils:
#     """
...
#         """
#         Retrieves the current version of the 'fluentai' package.
#
#         Returns:
#             str: The current version of 'fluentai'.
#
#         Raises:
...
#         try:
#             return get_package_version(pkg_name)
#         except PackageNotFoundError:
#             pass
#
#         # Read from docker environment
#         version = environ.get(envar_version)
#         if version:
#             return version
#
