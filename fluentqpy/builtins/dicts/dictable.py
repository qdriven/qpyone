...
__all__ = ["Dictable", "registry", "DictTable", "DatabaseDictable"]
...
class Dictable(object):
    ...
    def __call__(self, thingy):
        if self.ordered:
            ...
            d = dict()
        if not isinstance(thingy, DictTable):
            return d
...
class DictTable(object, metaclass=DictableMetaClass):
...
class DatabaseDictable(NamesMixin, DictTable):
    _database = None
    _table = None
    _database_name = None
    _table_name = None
