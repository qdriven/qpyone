...
from .exceptions import UnknownOrderType
from .exceptions import UpdateColumnEmptyException
from .type import Ordering
from .utils import clean_input_fields
from .utils import find_query_builder
from .utils import path_query_builder
...
class SQLAlchemyGeneralSQLQueryService(ABC):
    ...
    def get_join_by_excpression(
        self, stmt: BinaryExpression, join_mode=None
    ) -> BinaryExpression:
        if not join_mode:
            return stmt
