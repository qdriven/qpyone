...
class XlsxModel(BaseModel):
    ...
    @classmethod
    def from_file(cls: type["XlsxModel"], path: str | Path) -> "XlsxModel":
        """Loads data from a Excel file."""
        return cls.from_workbook(load_workbook(path))

    @classmethod
    def from_workbook(cls: type["XlsxModel"], wb: Workbook) -> "XlsxModel":
        """Loads data from a Excel file."""
    ...
    @classmethod
    def _ignore_key(cls, key: str | None) -> bool:
        """
