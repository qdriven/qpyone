...
from .fconfig_types import AttributeDict
from .fconfig_types import InterpolateEnumType
from .fconfig_types import InterpolateType
from .fconfig_types import as_bool
from .fconfig_types import clean
from .fconfig_types import interpolate_object
...
class Configuration:
    ...
    def __init__(
        ...
        self._default_levels: int | None = 1
    ...
    def _get_subset(self, prefix: str) -> dict[str, Any] | Any:
        """
